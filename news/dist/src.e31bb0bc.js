...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('http://localhost:3000/topStories').then(function (response) {
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h2", null, "The Latest Hacker News"), this.state.stories.map(function (item) {
        var id = item.id,
            by = item.by,
            score = item.score,
            title = item.title,
        ...
        return _react.default.createElement("div", {
          ...
          href: url
        }, _react.default.createElement("h3", null, title)), _react.default.createElement("p", null, "Upvotes: ", score), _react.default.createElement("p", null, by, " - ", new Date(time).toLocaleTimeString()));
      }));
    }
  }]);
